...
- Wind speed
- Humidity
- Sunrise/Sunset time ****(Update 2023-01-16: Reconstructed code, now the sunrise section displays sunrise/sunset time based on selected city's current local time; fixed the bug where it only shows city time in PST.)****
- Current date
